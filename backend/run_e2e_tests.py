    ...
    async with async_playwright() as p:
        ...
        try:
            ...
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/01_LandingPage.png", full_page=True
            )
            ...
            await page.wait_for_load_state("networkidle")
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/02_LoginPage.png", full_page=True
            )
            ...
            await page.wait_for_load_state("networkidle")
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/03_SignupPage.png", full_page=True
            )
            ...
            await page.wait_for_load_state("networkidle")
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/05_ReportIssue.png", full_page=True
            )
            ...
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/06_CommunityMap.png", full_page=True
            )
            ...
            await page.wait_for_load_state("networkidle")
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/07_Leaderboard.png", full_page=True
            )
            ...
            await page.wait_for_load_state("networkidle")
            await page.screenshot(
                path=f"{E2E_DIR}/screenshots/10_SwaggerDocs.png", full_page=True
            )
