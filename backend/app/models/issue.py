...
class Issue(Base):
    ...
    status = Column(String, default="PENDING", index=True) # PENDING, VERIFIED, ASSIGNED, IN_PROGRESS, RESOLVED, REOPENED, REJECTED, CLOSED
    ...
    parent_issue_id = Column(Integer, ForeignKey("issues.id"), nullable=True) # For duplicate prevention
    ...
    assigned_officer = relationship("User", foreign_keys=[assigned_officer_id], backref="assigned_issues")
