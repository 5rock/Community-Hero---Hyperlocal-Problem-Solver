...
class User(Base):
    ...
    email_hash = Column(String, unique=True, index=True, nullable=False) # For deterministic lookup
    ...
    role = Column(String, default="Citizen") # Citizen, Officer, Department Manager, Admin, Super Admin
    ...
    clearance_level = Column(Integer, default=0) # 0: Public, 1: Internal, 2: Confidential, 3: Secret
