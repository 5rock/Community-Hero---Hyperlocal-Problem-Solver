...
import { Mail, CheckCircle2, KeyRound, Lock, Eye, EyeOff } from 'lucide-react'
...
export default function ForgotPasswordPage() {
  ...
  return (
    <AuthLayout
      title={title}
      subtitle="Don't worry, it happens to the best of us. Let's get you back into your account safely and securely."
          ...
          >
            ...
            <form onSubmit={codeForm.handleSubmit(onCodeSubmit)} className="space-y-5">
              <div className="relative">
                ...
                />
                <KeyRound className="absolute left-3 top-[34px] text-muted-foreground" size={18} />
              </div>
              <Button
                type="submit"
                className="w-full h-12 text-base rounded-xl shadow-lg shadow-primary/20"
